  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "mathPuzzleCategoryCalculatorInfo":
            MessageLookupByLibrary.simpleMessage(
                "Вам потрібно правильно вирішити задане рівняння."),
        "mathPuzzleCategoryComplexCalculation":
            MessageLookupByLibrary.simpleMessage("Складне обчислення"),
        "mathPuzzleCategoryComplexCalculationInfo":
            MessageLookupByLibrary.simpleMessage(
                "Вам потрібно знайти правильний знак, який завершить задане рівняння."),
        "mathPuzzleCategoryCorrectAnswer":
            MessageLookupByLibrary.simpleMessage("Правильна відповідь"),
        "mathPuzzleCategoryCorrectAnswerInfo":
            MessageLookupByLibrary.simpleMessage(
                "Виберіть правильне число, щоб завершити рівняння."),
        "mathPuzzleCategoryDualGame":
            MessageLookupByLibrary.simpleMessage("Гра на двох"),
        "mathPuzzleCategoryDualGameInfo": MessageLookupByLibrary.simpleMessage(
            "Виберіть правильне число, щоб завершити рівняння."),
        "mathPuzzleCategoryFindMissing":
            MessageLookupByLibrary.simpleMessage("Знайдіть відсутнє"),
        "mathPuzzleCategoryFindMissingInfo":
            MessageLookupByLibrary.simpleMessage(
                "Виберіть правильне число, щоб завершити рівняння."),
        "mathPuzzleCategoryGuessSign":
            MessageLookupByLibrary.simpleMessage("Вгадаєш знак?"),
        "mathPuzzleCategoryGuessSignInfo": MessageLookupByLibrary.simpleMessage(
            "Вам потрібно знайти правильний знак, який завершить задане рівняння."),
        "mathPuzzleCategoryQuickCalculation":
            MessageLookupByLibrary.simpleMessage("Швидке обчислення"),
        "mathPuzzleCategoryQuickCalculationInfo":
            MessageLookupByLibrary.simpleMessage(
                "Вирішуйте прості рівняння одне за одним. Чим швидше ви вирішите, тим більше часу буде дано для вирішення наступного рівняння."),
        "mathPuzzleCategoryTrueFalse":
            MessageLookupByLibrary.simpleMessage("Правда чи хиба"),
        "mathPuzzleCategoryTrueFalseInfo": MessageLookupByLibrary.simpleMessage(
            "Виберіть правильне число, щоб завершити рівняння."),
        "mathPuzzleModeLabel":
            MessageLookupByLibrary.simpleMessage("Математична головоломка"),
        "mathPuzzleModeShortDesc": MessageLookupByLibrary.simpleMessage(
            "Кожна гра з простими розрахунками з різним підходом."),
        "memoryPuzzleCategoryConcentration":
            MessageLookupByLibrary.simpleMessage("Концентрація"),
        "memoryPuzzleCategoryConcentrationInfo":
            MessageLookupByLibrary.simpleMessage(
                "Виберіть правильне число, щоб завершити рівняння."),
        "memoryPuzzleCategoryCubeRoot":
            MessageLookupByLibrary.simpleMessage("Кубічний корінь"),
        "memoryPuzzleCategoryCubeRootInfo":
            MessageLookupByLibrary.simpleMessage(
                "Виберіть правильне число, щоб завершити рівняння."),
        "memoryPuzzleCategoryMathGrid":
            MessageLookupByLibrary.simpleMessage("Математична сітка"),
        "memoryPuzzleCategoryMathGridInfo": MessageLookupByLibrary.simpleMessage(
            "Виберіть число з математичної сітки, щоб досягти відповіді, показаної вище. Ви можете вибрати будь-яке число, щоб досягти вищезазначеної відповіді."),
        "memoryPuzzleCategoryMathematicalPairs":
            MessageLookupByLibrary.simpleMessage("Математичні пари"),
        "memoryPuzzleCategoryMathematicalPairsInfo":
            MessageLookupByLibrary.simpleMessage(
                "Кожна картка містить або рівняння, або відповідь. Зіставте рівняння з правильною відповіддю."),
        "memoryPuzzleCategoryMentalArithmetic":
            MessageLookupByLibrary.simpleMessage("Ментальна арифметика"),
        "memoryPuzzleCategoryMentalArithmeticInfo":
            MessageLookupByLibrary.simpleMessage(
                "Число з оператором буде показано по одному. Вам потрібно запам\'ятати число з оператором і записати кінцеву відповідь (без пріоритетів)."),
        "memoryPuzzleCategorySquareRoot":
            MessageLookupByLibrary.simpleMessage("Квадратний корінь"),
        "memoryPuzzleCategorySquareRootInfo":
            MessageLookupByLibrary.simpleMessage(
                "Знайдіть квадратний корінь вказаного числа."),
        ...
        "trainYourBrainMagicTriangleInfo": MessageLookupByLibrary.simpleMessage(
            "Сума кожного боку трикутника повинна дорівнювати вказаному числу. Щоб розмістити будь-яке число, виберіть круг трикутника та натисніть будь-яке вказане число з панелі."),
        "trainYourBrainModeLabel":
            MessageLookupByLibrary.simpleMessage("Тренуй свій мозок"),
        "trainYourBrainModeShortDesc": MessageLookupByLibrary.simpleMessage(
            "Покращуйте логічне мислення, концентрацію та основні когнітивні навички."),
        "trainYourBrainNumberPyramid":
            MessageLookupByLibrary.simpleMessage("Числова піраміда"),
        "trainYourBrainNumberPyramidInfo": MessageLookupByLibrary.simpleMessage(
            "Сума послідовних клітин повинна бути розміщена в верхній клітині. Вам потрібно правильно заповнити всі клітини, щоб вирішити Числову піраміду."),
        "trainYourBrainNumericMemory":
            MessageLookupByLibrary.simpleMessage("Числова пам\'ять"),
        "trainYourBrainNumericMemoryInfo": MessageLookupByLibrary.simpleMessage(
            "Виберіть правильне число, щоб завершити рівняння."),
